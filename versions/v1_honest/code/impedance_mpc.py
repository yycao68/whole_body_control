...
Key properties:
- Constant A_d (Proposition 1): offline precomputation of H^{-1}
- Contact-mode-indexed B_d^{(m)}: library keyed by frozenset of active feet
...
class ImpedanceMPC:
    ...
    B_d^(m)        = [[0], [-Λ_arm^{-1} * dt]]  — contact-mode indexed
    """
    ...
    def __init__(self, N=20, dt=0.001, Q=None, R=None, F_max=60.0):
        ...
        # Key: hashable frozenset of active foot names
        self._mode_library = {}
    ...
    def solve(self, x_e, Lambda_arm, mode_key=None,
        ...
        # Free response (with disturbance injection through all steps)
        ...
        # Gradient of QP cost
        h_qp = Gamma.T @ self._Q_bar @ x_free
