...
\subsection{Results for H2 (Disturbance-Observer Offset Reduction)}
...
\begin{table*}[!t]
\centering
\caption{H2: observer-based steady-state-offset reduction at the representation level and on the full torque-actuated G1 realizer; neither port falls.}
\label{tab:h2}
