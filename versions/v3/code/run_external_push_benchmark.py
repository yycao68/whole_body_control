#!/usr/bin/env python3
"""Phase-locked external-push benchmark (Stage 3B of the change plan).
...
controller in this primary comparison.  Four controllers, four direction/phase
conditions, and ten paired seeds give 160 push trials, reusing the terrain
...
reported separately per direction and phase (H5).  Remaining upright is not by
itself evidence.
"""
...
from run_uneven_ground_benchmark import (
    CONTROLLERS, PUSH_CONDITIONS, RESULTS, SIM_DT,
...
def main() -> None:
    ...
    path = RESULTS / "external_push_benchmark.json"
