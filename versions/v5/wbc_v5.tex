...
realization may be preferable; that comparison is a separate study.
\textbf{Perception is a separate rung.} The layer provides immediate stabilization within its authority; terrain
geometry (blind step-up) and disturbance anticipation come from perception and planning, and the layer's
authority boundary is a signal for those layers.
